...
module.exports = function(app) {
    ...
    app.route(BASE_URL + '/generate')
        .post(requestMiddleware.createAndValidateRequestBody, requestMiddleware.checkChannelID, dialCodeService.generateDialCodeAPI);
  ...
  app.route(BASE_URL + '/update/:dialCodeId')
    ...
    app.route(BASE_URL + '/search')
        .post(requestMiddleware.createAndValidateRequestBody, requestMiddleware.checkChannelID, dialCodeService.searchDialCodeAPI);
    
    app.route(BASE_URL + '/publish/:dialCodeId')
        .post(requestMiddleware.createAndValidateRequestBody, requestMiddleware.checkChannelID, dialCodeService.publishDialCodeAPI);
    
    app.route(BASE_URL + '/publisher/create')
        .post(requestMiddleware.createAndValidateRequestBody, requestMiddleware.checkChannelID, dialCodeService.createPublisherAPI);
    
    app.route(BASE_URL + '/publisher/read/:publisherId')
        .get(requestMiddleware.createAndValidateRequestBody, requestMiddleware.checkChannelID, dialCodeService.getPublisherAPI);

    app.route(BASE_URL + '/publisher/update/:publisherId')
        .patch(requestMiddleware.createAndValidateRequestBody, requestMiddleware.checkChannelID, dialCodeService.updatePublisherAPI);
